...
result1 = ingest_directory(SAMPLE_DIR, tracker=tracker, embeddings=fake_embeddings, use_llm_classifier=False, use_llm_injection_detector=False, use_pii_redaction=False)
...
result2 = ingest_directory(SAMPLE_DIR, tracker=tracker, embeddings=fake_embeddings, use_llm_classifier=False, use_llm_injection_detector=False, use_pii_redaction=False)
...
result_a = ingest_directory(root_a, tracker=shared_tracker, embeddings=fake_embeddings, use_llm_classifier=False, use_llm_injection_detector=False, use_pii_redaction=False)
...
result_b = ingest_directory(root_b, tracker=shared_tracker, embeddings=fake_embeddings, use_llm_classifier=False, use_llm_injection_detector=False, use_pii_redaction=False)
...
result_c = ingest_directory(crash_dir, tracker=crash_tracker, embeddings=fake_embeddings, use_llm_classifier=False, use_llm_injection_detector=False, use_pii_redaction=False)
